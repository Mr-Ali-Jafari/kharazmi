...
- [مستندات](docs/documentation.pdf) - مستندات پروژه
...
- **GitPython** - برای مدیریت Git
- **Requests** - برای ارتباط HTTP
- **PyQt5** - برای رابط کاربری

# افرادی که به این پروژه کمک کردند
- **دکتر توقیانی** - برای پشتیبانی فنی
- **سرکار خانم بلابادیان** - سرپرست پژوهشی
---
